...
CREATE VIEW activity AS
	select 
        ...
        */
        CASE
			WHEN act.photography_Interest="Y" and act.Wildlife_nature='Y' THEN 'Y'
            ELSE ' '
        ...
        LOWER(A.Comments) AS Comments,
          CASE
            WHEN LOWER(Comments) like LOWER('%photo%') THEN 'Y'
            ELSE ' '
        ...
        CASE
            ...
            snails|geckos|deers|Game Camp|raptors|hornbills|turtles|waterfalls|water fall|reserve|udawalawe') THEN 'Y'
            ELSE ' '
