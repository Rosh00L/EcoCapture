...
SET GLOBAL regexp_time_limit=100024;
 /**************************************************/
/**************************************************/
drop view if exists _No_photography;
CREATE VIEW _No_photography AS
	select 
	    act.InputID,
        act.Traveller_ID,
        act.photography,
