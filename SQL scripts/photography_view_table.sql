...
/**************************************************/
drop view if exists _photography;
CREATE VIEW _photography AS
	select 
	    act.InputID,
        act.Traveller_ID,
        act.photography,
